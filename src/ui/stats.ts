...
export type DisplayStat = number | string;

export function formatStat(value: DisplayStat): string {
...
export function statsRow(likes?: DisplayStat | null, views?: DisplayStat | null): CallbackButton[] {
