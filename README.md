...
- `JOIN_LOGS` and `STORAGE_CHANNEL_ID` accept numeric Telegram chat IDs only. Username targets are rejected. `STORAGE_CHANNEL_ID` is required for inline delivery and group slideshows containing more than ten items.
