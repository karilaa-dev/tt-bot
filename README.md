...
- Private chats have a three-item FIFO extraction queue; groups have ten. One extraction runs at a time per queue, and full-queue replies include a retry button.
