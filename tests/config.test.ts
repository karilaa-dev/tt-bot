...
const names = ["BOT_TOKEN", "DB_URL", "TT_SCRAP_API_KEY", "ADMIN_IDS", "TG_SERVER", "TT_SCRAP_BASE_URL", "TT_SCRAP_REQUEST_TIMEOUT_SECONDS", "MAX_USER_QUEUE_SIZE", "MAX_GROUP_QUEUE_SIZE", "MAX_ACTIVE_JOBS", "DB_POOL_SIZE"];
